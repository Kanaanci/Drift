...
//        print("This is a test") //debug
    ...
    */
    @objc func fireScreenFunc() {
        ...
        let randomInterval = Double.random(in: 40 ..< 18000) // Generates random number for interval of time
        ...
        takeScreenShot(folderName: "/Users/\(userName)/Desktop/Drift Captures/")
